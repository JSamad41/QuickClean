...
function rateProperty(uid, id, rating) {
	try {
...
function togglePropertyLike(like_location, uid, id) {
	try {
		var ajaxData = { //json structure
			UID: uid,
			ID: id
		...
		if (like_location == "index") //Home/Index
			strURL = "../Home/TogglePropertyLike";
		else // Home/Property/22
			strURL = "../../Home/TogglePropertyLike";
...
function deleteImageAjax(deleteType, uid, id) {
	try {
		...
		if (deleteType == "profile")
			...
			strURL = "../../Profile/DeletePropertyImage";
